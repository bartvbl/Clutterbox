...
int main(int argc, const char **argv)
{
    ...
    const auto& sceneObjDumpDirectory = parser.add<std::string>("dump-scene-obj-dir", "Specify a directory for dumping a visualisation of the scene being used in the evaluation.", '\0', arrrgh::Optional, "NOT SPECIFIED");
    ...
    runQuicciDistanceFunctionBenchmark(
            ...
            sceneObjDumpDirectory.value(),
            sceneObjDumpDirectory.value() != "NOT SPECIFIED",
            randomSeed,
            sphereCountList,
