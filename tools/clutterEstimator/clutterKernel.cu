...
__global__ void computeClutterKernel(
    ...
    const ShapeDescriptor::OrientedPoint origin = origins.content[blockIdx.x];
...
ShapeDescriptor::cpu::array<float> computeClutter(ShapeDescriptor::gpu::array<ShapeDescriptor::OrientedPoint> origins, ShapeDescriptor::gpu::PointCloud samplePointCloud, float spinImageWidth, size_t referenceObjectSampleCount, size_t referenceObjectOriginCount) {
